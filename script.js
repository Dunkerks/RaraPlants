const plants = [
  {
    id: 1,
    title: "Трутовик лакований (Ganoderma lucidum)",
    category: "griby",
    image: "images/ganoderma.jpg",
    description: "Нейстівний деревний гриб родини ганодермові, використовується у народній медицині."
  },
  {
    id: 2,
    title: "Порхавка гігантська (Calvatia gigantea)",
    category: "griby",
    image: "images/calvatia.jpg",
    description: "Їстівний вид грибів родини печерицевих."
  },
  {
    id: 3,
    title: "Ісландський мох (Cetraria islandica)",
    category: "lishayniki",
    image: "images/cetraria.jpg",
    description: "Листовидно-кущовий лишайник родини пармелієвих, використовується в медицині."
  },
  {
    id: 4,
    title: "Аденофора лілієлиста (Adenophora lilifolia)",
    category: "kvitky",
    image: "images/adenophora.jpg",
    description: "Рідкісна багаторічна трав'яниста рослина родини дзвоникових."
  },
  {
    id: 5,
    title: "Біломох сизий (Leucobryum glaucum)",
    category: "lishayniki",
    image: "images/leucobryum.jpg",
    description: "Мох, який поширений на лісах, болотах та скелях."
  },
  {
    id: 6,
    title: "Гіяцинтик блідий (Hyacinthella leucophaea)",
    category: "kvitky",
    image: "images/hyacinthella.jpg",
    description: "Рослина родини Холодкові, поширена в Східній Європі."
  },
  {
    id: 7,
    title: "Зірочки Ліотарда (Gagea liotardii)",
    category: "kvitky",
    image: "images/gagea.jpg",
    description: "Невисока трава з квітками, поширена в Європі та Азії."
  },
  {
    id: 8,
    title: "Вишня степова (Prunus fruticosa)",
    category: "kvitky",
    image: "images/prunus.jpg",
    description: "Маленький кущ з кисло-солодкими плодами, росте в степах та узліссях.Вишня степова, або кущова (лат. Prúnus fruticósa) — дерево (кущ) родини розових заввишки 0,2—2 м, найчастіше бувають 1-1,6 м заввишки. Листки вишні степової дрібні, цілісні, подібні до листків вишні звичайної, квітки теж дрібні, зібрані в коротенькі зонтикоподібні 3-4-квіткові суцвіття на кінцях дуже коротких пазушних пагонів. Віночок і численні (20- 25) тичинки прикріплені до увігнутого квітколожа, на дні якого міститься вільна зав'язь. По дну квітколожа розміщені нектарники. Плід — округло-яйцеподібна, червона або темно-червона кістянка. Свіжі плоди кисло-солодкі, містять 7-13 % цукрів, 0,1-2,5 % органічних кислот, до 0,8 % дубильних речовин, вітамін С, каротин та ін. Росте на степових ділянках, узліссях, схилах, серед чагарників. Культивується здавна, її дуже цінують садоводи як матеріал для гібридизації."
  }
, {
    id: 9,
    ...
    description: "Популяції нечисленні, трапляються рідко. Головні причини зміни чисельності — збирання рослини як лікарської сировини, вирубування лісів, рекреаційне навантаження."
  }, {
    id: 10,
    title: "Діфазіаструм сплюснутий ( Diphasiastrum complanatum)",
    category: "kvitky",
    image: "images/Diphasiastrum.jpg",
    description: "Зелени́ця сплю́щена (Diphasiastrum complanatum[1], Lycopodium complanatum (L.) Holub[2]) — багаторічна трав'яниста рослина заввишки до 40 см з родини плаунових. Має циркумполярне, субарктичне та альпійське поширення по всій Північній півкулі. Рідкісний вид, занесений до Червоної книги України. Лікарська, декоративна, технічна рослина."
  }, {
    id: 11,
    ...
    id: 21,
    title: "Гіропор каштановий, заячий гриб (Gyroporus castaneus)",
    category: "griby",
    image: "images/Gyroporus.jpg",
    description: "Каштановий гриб або гіропорус каштановий – це вид трубчастих капелюшкових грибів, представник роду гіропорус сімейства гіропорових. Зовні він нагадує білий гриб, але відрізняється від останнього ніжкою коричневого кольору, яка у каштанового гриба порожниста або з пустотами. Каштановик має масу корисних властивостей, завдяки своєму унікальному хімічному складу, до якого входить клітковина, природний білок, мінерали, вітаміни та мікроелементи. Він має антиоксидантну дію через наявність тіаніну. Лікарські препарати на основі гриба мають такі корисні властивості.Цей рідкісний лісовий вигляд, каштановий гриб, внесений до Червоної книги України. Він росте під широколистяними деревами. Утворює мікоризу з буками, дубами та представниками хвойних порід. Цей гриб або гіропорус каштановий має кілька схожих видів, їстівних та не їстівних."
  }, {
    id: 22,
