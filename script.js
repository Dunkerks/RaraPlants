const plants = [
  {
    ...
    description: "Багаторічна трав’яниста рослина. Заввишки 50-100 см. Стебло прямостояче товсте, не розгалужене, опушене жорсткими волосками. Листки вузькі ланцетні. Квіти яскраво-сині діаметром 1-2 см, лійкоподібні, по краю війчасті, зібрані в густе суцвіття на верхівці стебла. Цвіте у червні-липні. Плід – коробочка з дрібним насінням. Квіти запилюються комахами.Зростає у світлих дубових лісах, на узліссях.Охороняється на обласному рівні.Загрози: суцільні вирубки світлих дубових лісів та створення культур хвойних на місці широколистяних лісів.Рекомендації по охороні: проводити моніторинг стану ізольованих популяцій та зберігати світлі дубові ліси.Охороняється у заказнику «Шалигінський», у НПП «Деснянсько-Старогутський» було відомо одне місцезростання, яке на сьогоднішній день вже втрачено.."
  }, {
    id: 28,
